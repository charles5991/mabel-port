  ...
  return (
    <div ref={ref} className=" w-fit">
      {isInView ? (
        ...
        >
          Highly motivated and currently seeking a
          <span className="hidden sm:inline-block">seeking a</span> challenging
          position
          <br className="hidden xsm:block sm:hidden" /> in the IT sector.
        </SmotionP>
      ) : (
        <></>
      )}
